class Testlibcoap < Formula
  desc "Test Lightweight application-protocol for resource-constrained devices"
  ...
  option "with-examples", "Build without examples"
